...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            // initialize JSON payload as empty
            String jsonResponse = "";

            // check if there actually is a url
            if (url == null) {
            ...
            try {
                ...
                if (urlConnection.getResponseCode() == 200) {
                    ...
                    Log.e(LOG_TAG, "HTTP response code (should be 200): " + urlConnection.getResponseCode());
                }

            // IOException is thrown by getInputStream() if HTTP response code indicates an error
            } catch (IOException e) {

                // log exception stack trace
                Log.e(LOG_TAG, "Problem connecting to JSON url. " + e.getStackTrace(), e);

                // jsonResponse remains as empty String
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            ...
            // it is possible that the JSON payload is an empty string
            // check this case first, and exit method if JSON is empty
